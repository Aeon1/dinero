...
function pieChart() {
  ...
  var pullOutBorderStyle = "";                  // Colour of the pull-out slice border
  ...
  function init() {
    ...
    $('#chartData td').each( function() {
      ...
      if ( rgb = $(this).parent('tr').css('color').match( /rgb\((\d+), (\d+), (\d+)/) ) {
  ...
  function drawSlice ( context, slice ) {
    ...
    var endAngle = chartData[slice]['endAngle']  + chartStartAngle;
      ...
      //posicion y leyendas dentro del la grafica
    if ( slice == currentPullOutSlice ) {   
      ...
      context.fillStyle = 'rgb(0,0,0)'; //'rgb(' + chartColours[slice].join(',') + ')'; color de las leyendas
      context.textAlign = "center";
      context.font = pullOutLabelFont;
      context.fillText( chartData[slice]['label'],50 , 15 );
      context.font = pullOutValueFont;
      context.fillText( pullOutValuePrefix + chartData[slice]['value'] + " (" + ( parseInt( chartData[slice]['value'] / totalValue * 100 + .5 ) ) +  "%)", 50 ,  30 );
